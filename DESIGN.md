...
The approved direction combines A (technical/editorial) and C (authorial/balanced). The page behaves like a small programming laboratory: a live pixel character and a Python code panel lead the first viewport, while the rest of the page is a calm, legible portfolio.
